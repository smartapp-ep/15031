...
$page=ubo($_GET["page"]);
if ($page){
echo msglayerurl("删除成功",8,"zhibo.php?page=$page");
}else{
echo msglayerurl("删除成功",8,"zhibo.php");
}
}
?>
<!DOCTYPE html>
...
<li class="layui-this"><a href="zhibo.php">直播资源</a></li>
<li class=""><a href="zhibotj.php">添加资源</a></li>
<?php
$sql = mysql_query("SELECT * FROM ubozb");
...
<label class="layui-form-label">主播名</label>
<div class="layui-input-inline">
<input type="text" name="name" value="<?php if($name==null){ }else{ echo $name;}?>" placeholder="主播名" class="layui-input">
</div>
</div>
<div class="layui-inline">
...
$query = mysql_query("select * from  ubozb   ".$sql." order by id desc   limit $offset, $Page_size");
...
<td align="center">
<a href="zhiboedit.php?id=<?php echo $a[id]?>&page=<?php echo $page?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
