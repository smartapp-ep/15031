      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="password" name="dbpw" id="dbpw" value="root" class="input" autoComplete="off" onBlur="TestDbPwd()"></td>
            <td><div id="J_install_tip_dbpw"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库名：</td>
            <td><input type="text" name="dbname" id="dbname" value="ubolm" class="input"></td>
  ...
  function TestDbPwd()
    {
        ...
        var url =  "<?php
echo $_SERVER['PHP_SELF']; ?>?step=3&testdbpwd=1";
        $.ajax({
            type: "POST",
            url: url,
            data: data,
